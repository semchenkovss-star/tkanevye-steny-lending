export const PHONE_DISPLAY = '+7 (495) 797-08-09';
export const PHONE_HREF = 'tel:+74957970809';
export const WORK_HOURS = 'Пн–Сб, 9:00–20:00';
export const EMAIL = 'fabricwall@mail.ru';
export const EMAIL_HREF = 'mailto:fabricwall@mail.ru';
export const ADDRESS = 'г. Москва, пер. Переведеновский, д. 3';
