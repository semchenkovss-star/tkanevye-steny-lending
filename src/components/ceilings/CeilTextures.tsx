...
const CeilTextures = () => {
  ...
  return (
    <Section
      ...
      lead="Бесшовные полотна шириной до 5 метров: комната закрывается целиком, без стыков посередине. Образцы всех фактур замерщик привозит с собой — их можно посмотреть при своём освещении."
      tone="surface"
    >
