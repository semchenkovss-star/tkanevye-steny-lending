...
export const CeilWhat = () => (
  <Section
    ...
    index="02"
    eyebrow="Технология"
    title={<>Как устроен натяжной потолок</>}
    lead="Полотно не крепится к плите: оно держится на багете по периметру комнаты. Поэтому состояние бетона больше не имеет значения."
  >
