...
const Fabrics = () => {
  ...
  return (
    <Section
      ...
      lead="Шесть коллекций — от бюджетного «Комфорта» до акустических коллекций. Полную палитру замерщик привозит с собой: образцы можно приложить к мебели и посмотреть при своём свете."
      tone="surface"
    >
