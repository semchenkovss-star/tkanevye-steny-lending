  ...
  return (
    <div className="min-h-screen bg-background">
      <Seo
        ...
        description="Архитектурный текстиль для стен и потолков: лён, велюр, рогожка, микрошенилл. Фильтр по стилю, помещению и цене. Шумоизоляция до −11 дБ, образцы на дом."
        path="/catalog"
