  ...
  return (
    <div className="min-h-screen bg-background">
      <Seo
        ...
        description="Архитектурный текстиль для стен и потолков: коллекции Комфорт, Луна, Марс, Узор, Штукатурка, Акустик и Модерн. Фильтр по стилю, помещению и цене. Шумоизоляция до −11 дБ, образцы на дом."
        path="/catalog"
        keywords="ткань для стен, акустическая ткань, каталог тканей для стен, цена ткани за м2, образцы ткани, архитектурный текстиль"
        jsonLd={jsonLd}
      />
