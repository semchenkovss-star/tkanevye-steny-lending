  ...
  return (
    <div className="min-h-screen bg-background">
      <Seo
        ...
        description="Каталог тканевых стен под ключ: лён, велюр, рогожка, акустический фетр и микрошенилл. Фильтр по стилю интерьера, помещению и цене. Шумоизоляция до −11 дБ, гарантия до 5 лет, бесплатный замер."
        path="/catalog"
        jsonLd={jsonLd}
      />
      ...
      <main className="shell py-14 sm:py-16 lg:py-20">
        ...
        <p className="mt-6 max-w-[42em] text-base leading-[1.6] text-muted-foreground">
          ...
          интерьера и бюджету — точную смету посчитает замерщик бесплатно.
        </p>
            ...
            <div className="mt-10 flex flex-col items-start justify-between gap-6 border border-border bg-foreground p-6 text-background sm:flex-row sm:items-center sm:p-8">
              <div>
                ...
                <p className="mt-3 max-w-[34em] text-sm leading-[1.55] text-background/60">
                  В наличии 180 оттенков — замерщик привезёт образцы к вам домой бесплатно.
                </p>
              </div>
              <Link
                to="/#calc"
