...
const AcousticsPage = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      <Seo
        title="Звукоизоляция комнаты под ключ: замер и монтаж | Fabric Wall"
        ...
        path="/acoustics"
        keywords="звукоизоляция комнаты, шумоизоляция квартиры от соседей, звукоизоляция стен под ключ, замер шума, акустическая обработка помещения"
