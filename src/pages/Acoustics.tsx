...
const JSON_LD = [
  {
    ...
    '@type': 'Service',
    serviceType: 'Акустические решения под ключ',
    ...
    offers: {
      ...
      price: '2100',
      priceCurrency: 'RUB',
      description: 'Акустическая обработка стен и потолка под ключ, цена за м²',
    },
  },
  {
    '@context': 'https://schema.org',
...
const AcousticsPage = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      <Seo
        title="Акустические решения под ключ в Москве — тише за 1–3 дня | Полотно"
        description="Убираем эхо и шум соседей: замер шумомером, расчёт площади обработки, акустические полотна на стены и потолок. Монтаж за 1–3 дня, контрольный замер и гарантия результата."
        path="/acoustics"
      ...
      <section className="relative w-full overflow-hidden bg-foreground text-background">
        ...
        <div className="relative z-10 shell py-16 sm:py-24 lg:py-32">
          ...
          <p className="mt-6 max-w-[36em] text-base leading-[1.6] text-background/70">
            Считаем эхо и шум приборами, подбираем полотно и площадь обработки, монтируем стены и
            потолок одной бригадой. От 2 100 ₽ / м² под ключ.
          </p>
      ...
      <main>
        <Section
          ...
          lead="Три ситуации, с которыми к нам приходят чаще всего. Если узнали свою — задача решается за один-три дня."
        >
        ...
        <Section
          ...
          lead="Работаем от измерений, а не на глаз: сначала цифры, потом смета, в конце — контрольный замер."
          tone="surface"
        >
          ...
          <div className="shell py-16 sm:py-20 lg:py-28">
            <div className="grid gap-12 lg:grid-cols-12">
              <div className="lg:col-span-5">
                <span className="font-display text-sm tracking-[0.2em] text-primary">05</span>
