...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      <Seo
        title="Тканевые стены под ключ в Москве — тихие натяжные стены за 1 день | Полотно"
        description="Натяжные тканевые стены на скрытом каркасе: ровная стена за 1–2 дня без штукатурки, пыли и просушки. Тихие стены со звукопоглощением αw = 0,30 (MH), скрытие неровностей и коммуникаций, гарантия до 5 лет. Замер и смета за 24 часа."
        path="/"
        jsonLd={JSON_LD}
      />
      <StickyHeader />
