  ...
  return (
    <div className="min-h-screen bg-background">
      <Seo
        ...
        description="Тканевые стены на скрытом каркасе: ровная стена за 1–2 дня без штукатурки, пыли и просушки. Шумоизоляция до −9 дБ, скрытие неровностей и коммуникаций, гарантия до 5 лет. Замер и смета за 24 часа."
        path="/"
        jsonLd={JSON_LD}
      />
      <StickyHeader />
