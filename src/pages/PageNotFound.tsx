  ...
  return (
    <div className="flex min-h-screen flex-col bg-background">
      ...
      <main className="shell flex flex-1 flex-col justify-center py-20 sm:py-28">
        <span className="font-display text-sm tracking-[0.2em] text-primary">404</span>
        ...
        <div className="mt-10 grid gap-px border border-border bg-border sm:grid-cols-2 lg:grid-cols-3">
          {LINKS.map((l) => (
            ...
            >
              <Icon name={l.icon} size={22} className="shrink-0 text-primary" />
        ...
        <a
          href={PHONE_HREF}
          className="mt-10 flex items-center gap-3 font-display text-[1.75rem] uppercase leading-none tracking-[0.01em] text-foreground transition-colors hover:text-primary sm:text-[2.25rem]"
        >
